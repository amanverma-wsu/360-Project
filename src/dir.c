/*
 * CougFS: Directory Operations Implementation
 *
 * Directories are stored as regular files whose data blocks contain
 * arrays of fixed-size directory entries (cougfs_dir_entry_t).
 */
