/*
 * CougFS: Bitmap Operations Implementation
 *
 * Manages inode bitmap (1 block) and data block bitmap (1 block).
 * Each bit represents the allocation status of one inode or data block.
 */
